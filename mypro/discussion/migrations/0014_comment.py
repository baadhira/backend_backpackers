...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('discussion', '0013_delete_comment'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_discussion', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='from_discussion', to='discussion.discussion')),
